...
#ifndef _xD3D11DeviceContext_h_
#define _xD3D11DeviceContext_h_

#include "xd3d9.h"

class xD3D11DeviceContext : public ID3D11DeviceContext
{
public:
	xD3D11DeviceContext(ID3D11DeviceContext* dev)
	{
		m_device = dev;
	}
	virtual ~xD3D11DeviceContext()
	{
