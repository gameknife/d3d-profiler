...
#include "./../dxsdk/Include/dinputd.h"
...
{
	InputDeviceBase( xInputManager* creator, const char* deviceName, const GUID& guid );
	...
	xInputManager*			GetInputManager() {return m_creator;}
	EDeviceId				m_deviceId;

protected:
	xInputManager*			m_creator;
	DWORD					m_dwCoopLevel;
	bool					m_bNeedsPoll;
};
